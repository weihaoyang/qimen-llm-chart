...
export const sessionApi = {
  ...
  profile: () => request<{ profile: { profile: Record<string, unknown> } | null; decisionDna?: Array<Record<string, unknown>>; archonProgress:{ reviewedBattles:number; committedBattles:number; collaborationBattles:number; archiveUnlocks:number; score:number; rankTitle:string; seals:number; privileges:{ precognition:boolean; archiveAnnotation:boolean; realityProposal:boolean } } }>(`/api/battles/profile`),
