...
export const sessionApi = {
  ...
  createAdvice: (battleId:string, input:{ targetType:"battle"|"fact"|"junction"|"move"|"commitment"|"review"; targetId?:string|null; opinion:string; rationale:string; uncertainty:string }) => request<{ advice:Record<string, unknown> }>(`/api/battles/${battleId}/advice`, { method:"POST", body:JSON.stringify(input) }),
